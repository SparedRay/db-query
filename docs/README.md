...
| 11 | [A second engine: Elasticsearch SQL](stage-11-elasticsearch.md) | 📋 **Planned** — analysis only; an engine trait plus capabilities, built for N engines and proved on MySQL first |
